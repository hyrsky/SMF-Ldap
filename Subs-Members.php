...
function registerMember(&$regOptions, $return_errors = false)
{
	...
	if (empty($regOptions['auth_method']) || !in_array($regOptions['auth_method'], array('password', 'openid', 'ldap')))
	{
	...
	$regOptions['register_vars'] = array(
		...
		'ldap_user' => (integer)($regOptions['auth_method'] == 'ldap'),
	);
	...
	$knownInts = array(
		...
		'id_theme', 'is_activated', 'id_msg_last_visit', 'id_post_group', 'total_time_logged_in', 'warning','ldap_user'
	);
	$knownFloats = array(
		'time_offset',
	);
