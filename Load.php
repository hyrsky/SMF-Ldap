...
function loadUserSettings()
{
	...
	$user_info += array(
		...
		'permissions' => array(),
		'ldap_user' => isset($user_settings['ldap_user']) && $user_settings['ldap_user'] == true,
	);
...
function loadMemberData($users, $is_name = false, $set = 'normal')
{
	...
	if ($set == 'normal')
	{
		$select_columns = '
			...
			mem.ldap_user, mem.signature, mem.personal_text, mem.location, mem.gender, mem.avatar, mem.id_member, mem.member_name,
	...
	elseif ($set == 'minimal')
	{
		$select_columns = '
			...
			mem.posts, mem.last_login, mem.member_ip, mem.member_ip2, mem.lngfile, mem.id_group, mem.ldap_user';
		$select_tables = '';
	}
	else
